...
//app.use(expressLogger('dev'));  /* 'default', 'short', 'tiny', 'dev' */
...
const conn = mongoose.connect('mongodb://localhost/terezin', () => { /* dummy function */ })
	.then((db) => { 
		/*
		Import data
		**/
...
var conn3 = mongoose.connect('mongodb://localhost/terezin', function (err, db) {
